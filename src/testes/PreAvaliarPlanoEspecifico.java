...
public class PreAvaliarPlanoEspecifico {
	...
	public void openBrowser() throws MalformedURLException {
		...
		public void testeLoginEmailValido() throws Exception {
			try {
				...
				driver.findElement(By.xpath("//*[@id=\"locovelho:tabelaDeNegocios:globalFilter\"]")).sendKeys("1111");
				...
				TestLinkUtils.reportResult("Pré avaliar um Plano de Negócio específico", null, TestLinkAPIResults.TEST_PASSED);
			} catch (Exception e) {
 				TestLinkUtils.reportResult("Pré avaliar um Plano de Negócio específico", e.getMessage(), TestLinkAPIResults.TEST_FAILED);
