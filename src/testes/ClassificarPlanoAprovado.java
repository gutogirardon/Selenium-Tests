...
public class ClassificarPlanoAprovado {
	...
	public void openBrowser() throws MalformedURLException {
		...
		public void testeLoginEmailValido() throws Exception {
			try {
				...
				TestLinkUtils.reportResult("Classificar Plano - Aprovado", null, TestLinkAPIResults.TEST_PASSED);
			} catch (Exception e) {
 				TestLinkUtils.reportResult("Classificar Plano - Aprovado", e.getMessage(), TestLinkAPIResults.TEST_FAILED);
