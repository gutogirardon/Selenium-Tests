...
public class avaliarPlanoIndisponivelTest {
...
@Test
public void avaliarPlanoIndisponivelTest() {
    try {
        ...
        driver.findElement(By.xpath("//*[@id=\'locovelho:tabelaDeNegocios_paginator_bottom\']/span/a[2]")).click();


        driver.findElement(By.xpath("//*[@id=\'locovelho:tabelaDeNegocios:16:sendoAvaliado\']/span[2]")).click();

        TestLinkIntegration.updateResults("Avaliar Plano de Negócio já avaliado", null, TestLinkAPIResults.TEST_PASSED);
