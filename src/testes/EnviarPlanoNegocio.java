...
public class EnviarPlanoNegocio {
	...
	public void openBrowser() throws MalformedURLException {
		//System.setProperty("webdriver.chrome.driver", "/home/guto/Documentos/chromedriver");
		System.setProperty("webdriver.gecko.driver", "/home/guto/Documentos/geckodriver");
	...
	public void cadastroPlanoNegocioObrigatorio() throws Exception {
		...
		try {
			...
			// aqui come�a o cadastro do plano de negocio
			...
			driver.findElement(By.id("formulario_cadastro_projeto:segmentoDeClientes"))
					.sendKeys("Segmento de clientessssssssss");
			;

			driver.findElement(By.id("formulario_cadastro_projeto:propostaDeValor")).clear();
			driver.findElement(By.id("formulario_cadastro_projeto:propostaDeValor")).sendKeys("Proposta de valorrrr");
			;

			driver.findElement(By.id("formulario_cadastro_projeto:atividadesChave")).clear();
			driver.findElement(By.id("formulario_cadastro_projeto:atividadesChave")).sendKeys("Atividades chaveeeee");
			;
			...
			// aqui come�a aba analise de mercado
			...
			driver.findElement(By.name("formulario_cadastro_projeto:relacoComClientes"))
					.sendKeys("Relacoes com o cliente");
			;

			driver.findElement(By.id("formulario_cadastro_projeto:parceriasChaves")).clear();
			driver.findElement(By.id("formulario_cadastro_projeto:parceriasChaves")).sendKeys("parcerias  chaveeeee");
			;
			...
			// AQUI ACABA A ABA PRODUTO OU SERVI�O
			...
			driver.findElement(By.id("formulario_cadastro_projeto:participacaoAcionaria"))
					.sendKeys("PARTICIPACAO ACIONARIO SOCIOS BLABLA");
			;
			...
			driver.findElement(By.id("formulario_cadastro_projeto:potencialEmprego"))
					.sendKeys("POTENCIAL DE GERACAO DE EMPREGO E RENDA BLABLABLA");
			;
