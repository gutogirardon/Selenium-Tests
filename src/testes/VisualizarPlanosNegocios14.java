...
public class VisualizarPlanosNegocios14 {
	...
	public void openBrowser() throws MalformedURLException {
		...
		public void testeLoginEmailValido() throws Exception {
			try {
				...
				TestLinkUtils.reportResult("Visualizar Plano de Negócios", null, TestLinkAPIResults.TEST_PASSED);
			} catch (Exception e) {
 				TestLinkUtils.reportResult("Visualizar Plano de Negócios", e.getMessage(), TestLinkAPIResults.TEST_FAILED);
