...
public class testegerentenotificado {
	...
	public void testEsMGP59() throws Exception {
		...
		try {
              ...
              Thread.sleep(2000);
              new Select(driver.findElement(By.name("locovelho:tabelaDeNegocios:j_idt42"))).selectByVisibleText("Em Pré-Avaliação");
             Thread.sleep(2000);
              driver.findElement(By.cssSelector("option[value=\"Em Pré-Avaliação\"]")).click();
              Thread.sleep(2000);
