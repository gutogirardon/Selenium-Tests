...
public class VisualizarPNeFiltrarTabela {
	...
	public void testEsMGP59() throws Exception {
		...
		try {
			...
			new Select(driver.findElement(By.name("locovelho:tabelaDeNegocios:j_idt42")))
					.selectByVisibleText("Submetido");
			Thread.sleep(2000);
			driver.findElement(By.cssSelector("option[value=\"Submetido\"]")).click();
			Thread.sleep(2000);
		...
		TestLinkUtils.reportResult("Filtrar pelo nome do plano", null,
				TestLinkAPIResults.TEST_PASSED);
	} catch (Exception e) {
		TestLinkUtils.reportResult("Filtrar pelo nome do plano", e.getMessage(),
