...
public class ClassificarPlanoReprovado {
	...
	public void openBrowser() throws MalformedURLException {
		...
		public void testeLoginEmailValido() throws Exception {
			try {
				...
				//Selecionar Reprovado
				driver.findElement(By.xpath("//*[@id=\"formulario_comentarpreavalizar:avaliacao\"]/tbody/tr[3]/td[2]/label")).click();
				
				//botao
				dropdown.selectByVisibleText("Salvar Pré-Avaliação");					
				
				TestLinkUtils.reportResult("Classificar Plano - Reprovado", null, TestLinkAPIResults.TEST_PASSED);
			} catch (Exception e) {
 				TestLinkUtils.reportResult("Classificar Plano - Reprovado", e.getMessage(), TestLinkAPIResults.TEST_FAILED);
